...
export default function ProfilScreen({ navigation }) {
    ...
    const loadProfile = async () => {
        ...
        try {
            ...
            const baskanKulupId = await AsyncStorage.getItem('baskanKulupId');
            const storedKulupAd = await AsyncStorage.getItem('baskanKulupAd');

            if (baskanKulupId) {
                setIsBaskan(true);
                setBaskanKulupAd(storedKulupAd || '');
            }
